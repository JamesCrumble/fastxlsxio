...
class ReadOnlyWorkbook:
    ...
    def read_worksheets(
        self,
        worksheets_to_read: dict[str | int, list[RangeInfo]],
        ...
        Examples
        --------
        >>> from fastxlsxio import WorkbookReanonly, RangeInfo, DShape, DType
    ...
    def read_worksheets(
        self,
        worksheets_to_read: dict[str | int, dict[str, RangeInfo]],
...
class WriteOnlyWorksheet:
    ...
    def write_matrix(
        self,
        cell_addr: tuple[int, int] | str,
        value: np.ndarray | list[list[Any]],
        *,
        dtype: DType | None = None,
    ):
...
@overload
def read_many(
    workbooks_to_read: dict[str, dict[int | str, list[RangeInfo]]],
) -> dict[str, dict[int | str, list[Any]]]:
    ...
    Examples
    --------
    >>> from fastxlsxio import RangeInfo, DShape, DType, read_many
    >>> wb = WorkbookReanonly("example.xlsx")
    >>> workbooks_to_read = {
            "workbook1.xlsx": {
                "Sheet1": [
...
@overload
def read_many(
    workbooks_to_read: dict[str, dict[int | str, dict[str, RangeInfo]]],
